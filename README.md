...
Add commands 'from' amd 'to' to the simple calculator from chapter 6,
to let it take input from a file and output results to another file (from exercise 25 of chapter 9):
